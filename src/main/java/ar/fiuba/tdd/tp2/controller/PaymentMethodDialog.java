...
public class PaymentMethodDialog implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        JLabel banksText = new JLabel("Seleccione el banco:");
        banksText.setBounds(25, 20, 350, 20);

        JComboBox<String> banks = new JComboBox<String>();
        banks.setBounds(25, 50, 350, 25);
        banks.addItem("PARISIA");
        banks.addItem("CAPRO");
        banks.addItem("NO_ONE");

        JLabel paymentMethodText = new JLabel("Seleccione el método de pago:");
        paymentMethodText.setBounds(25, 95, 350, 20);

        JComboBox<String> paymentMethods = new JComboBox<String>();
        paymentMethods.setBounds(25, 125, 350, 25);
        paymentMethods.addItem("CASH");
        paymentMethods.addItem("DEBIT");
        paymentMethods.addItem("CREDIT");

        JButton cancelButton = new  JButton("Cancelar");
        cancelButton.setBounds(265, 165, 100, 25);
        ...
        acceptButton.setBounds(35, 165, 100, 25);
        acceptButton.setBackground(new Color(53,131,199));
        acceptButton.setFocusPainted(false);
        acceptButton.setForeground(Color.white);
        acceptButton.addActionListener(new FinishSaleListener(this.window, this.cashReg, dialog, banks, paymentMethods));

        panelDialog.add(banksText);
        panelDialog.add(banks);
